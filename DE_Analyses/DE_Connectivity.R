...
Salt <- setdiff(my_dataSig$condition_saltDE_results$Gene, my_dataSig$condition_nutDE_results$Gene)

Shared <- intersect(my_dataSig$condition_nutDE_results$Gene, my_dataSig$condition_saltDE_results$Gene)
